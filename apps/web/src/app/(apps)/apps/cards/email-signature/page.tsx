...
} from '../../../../(dashboard)/email-signature/signature-utils'
import {
...
} from '../../../../(dashboard)/email-signature/components'
import { encodeSvgData, getToken } from '../../../../(dashboard)/email-signature/helpers'
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        const data = await apiGet<ItemsResponse<CardSummary> | CardSummary[]>(
          '/cards?include=theme,socialLinks,qrCode',
          token,
        )
