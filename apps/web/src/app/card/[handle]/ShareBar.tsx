...
import { getPublicApiUrl, isGoogleWalletEnabled } from '@/lib/public-env'
...
function useWalletSupport() {
  ...
  useEffect(() => {
    ...
    setGoogleSupported(isGoogle)
  }, [])

  return { googleSupported }
}
  ...
  return (
    ...
    >
      ...
      {/* Wallet row — only rendered on supported devices.
          Apple Wallet stays hidden until real pass signing is implemented server-side. */}
      {allowAnonymousExport && googleSupported && googleWalletEnabled && (
