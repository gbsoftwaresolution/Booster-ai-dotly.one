            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="group/continue relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-[20px] bg-gray-950 px-8 py-5 text-base font-extrabold text-white shadow-[0_0_0_1px_rgba(255,255,255,0.1)_inset,0_8px_30px_rgba(0,0,0,0.12)] transition-all duration-500 hover:scale-[1.02] hover:bg-gray-900 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.2)_inset,0_20px_40px_rgba(0,0,0,0.2)] active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 via-sky-500/20 to-indigo-500/20 opacity-0 transition-opacity duration-500 group-hover/continue:opacity-100" />
                  <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent transition-transform duration-1000 group-hover/continue:translate-x-[200%]" />
                  <span className="relative z-10 tracking-wide">
                    {profileSaving ? 'Saving profile...' : 'Continue to first card'}
                  </span>
                  {!profileSaving && (
                    <svg
                      className="relative z-10 ml-2 h-5 w-5 transition-transform duration-500 group-hover/continue:translate-x-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2.5}
