  ...
  return (
    <div className="flex flex-col lg:hidden relative z-10 w-full px-2">
      ...
      <div className="relative mx-auto mt-16 w-full max-w-[340px] [perspective:1200px]">
        ...
        <div className="relative z-10 transform-gpu [transform:rotateY(-5deg)_rotateX(5deg)] rounded-[38px] border-[1.5px] border-white/80 bg-white/40 p-3 shadow-[0_32px_64px_-16px_rgba(15,23,42,0.15),0_0_0_1px_rgba(255,255,255,0.5)_inset] backdrop-blur-2xl">
          {/* Inner Screen */}
          <div className="relative overflow-hidden rounded-[28px] bg-slate-950 p-6 shadow-inner">
            ...
            <div className="relative pt-2">
              ...
              <h3 className="mt-4 text-center text-2xl font-bold tracking-tight text-white">
                Alex Johnson
              </h3>
